...
- Implementación de **CAPI** para recuperar conversiones perdidas por bloqueadores
- Integración con **Tevia CRM** para automatizar el seguimiento de leads
- **Tevia Assist** para calificación inicial de prospectos 24/7

### Resultados

| Métrica | Antes | Después | Variación |
|---|---|---|---|
| Costo por lead (Meta) | $85.000 COP | $38.000 COP | **-55%** |
| Costo por lead (Google) | $120.000 COP | $67.000 COP | **-44%** |
| Tasa de conversión landing | 2.1% | 4.8% | **+128%** |
| Leads calificados / mes | 18 | 47 | **+161%** |
| Tiempo de respuesta a leads | 4–6 horas | 3 minutos | **-97%** |
| Conversiones recuperadas (CAPI) | — | +32% | **Nuevas** |

> *"Antes no sabíamos de dónde venían nuestros clientes. Ahora sabemos exactamente qué anuncio, qué canal y qué mensaje generó cada venta."*
...
| Métrica | Antes | Después | Variación |
|---|---|---|---|
| Tasa de respuesta a leads | 34% | 100% | **+194%** |
| Leads atendidos fuera de horario | 0% | 100% | **Nuevo** |
| Tiempo promedio de respuesta | 5.2 horas | 47 segundos | **-99.7%** |
| Tasa de cierre sobre leads | 12% | 28% | **+133%** |
| Costo operativo de atención | Alto | Reducido | **-60% est.** |
| ROI de inversión en pauta | 1.8x | 4.1x | **+128%** |

> *"El agente atiende mientras dormimos. Llegamos a la mañana con leads ya calificados listos para cerrar."*
...
## 🔑 El Patrón Detrás de Cada Resultado

Todos los casos comparten el mismo principio: **la infraestructura correcta multiplica el impacto de cada peso invertido en pauta.**

- Sin CAPI → pierdes entre el 20% y 40% de tus conversiones reales
- Sin personalización → tu landing convierte a la mitad de su potencial
- Sin automatización → pierdes leads por tiempo de respuesta
- Sin CRM → no hay seguimiento y el lead muere
